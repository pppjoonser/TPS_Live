...
{
	static ConstructorHelpers::FObjectFinder<UAnimMontage> HitMontageRef(TEXT("/Script/Engine.AnimMontage'/Game/Animation/EnemyHit.EnemyHit'"));
...
void UTPSEnemyAnimInstance::FinishAttackMontage(UAnimMontage*, bool bInterrupted)
{
